...
namespace TagsCloudVisualization
{
    ...
    public class CircularCloudLayouter_Should
    {
        ...
        {
            var cloud = new CircularCloudLayouter(new RectangleLocator(new Point(5, 5)));
        ...
        {
            var cloud = new CircularCloudLayouter(new RectangleLocator(new Point(10, 10)));
        ...
        {
            var cloud = new CircularCloudLayouter(new RectangleLocator(new Point(20, 20)));
